...
const MultiStepForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      navigate("/offers"); // ✅ Redirect to offers page after brief delay
    }, 1500);
  };
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white p-10 rounded-lg shadow-xl mt-10">
      {/* Progress Bar */}
      {!submitted && (
        <div className="relative mb-8">
          <div className="w-full h-4 bg-gray-300 rounded-full overflow-hidden" />
          <motion.div
            className="absolute top-0 left-0 h-4 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-600 rounded-full shadow-lg"
            initial={{ width: 0 }}
            animate={{ width: `${progressPercent}%` }}
            transition={{ duration: 0.5, ease: "easeInOut" }}
          />
          <div className="absolute top-0 left-0 w-full h-4 flex justify-between items-center px-3 text-xs font-semibold text-white pointer-events-none">
            ...
            <>
              ...
              {step === 2 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold mb-4">2. How long ago was your accident?</h2>
              ...
              {step === 3 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold mb-4">Was the accident your fault?</h2>
              ...
              {step === 4 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold mb-4">Did you receive medical attention?</h2>
              ...
              {step === 5 && (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <h2 className="text-xl font-bold mb-4">Have you signed any paperwork with an attorney?</h2>
                  {['No', 'Yes'].map(option => (
                    <label key={option} className="block mb-2">
                      <input
                        type="radio"
